  ...
  const layers: StackLayer[] = [
    {
      ...
      details: `Crawling completed on ${analysis.url}. SSL is active, sitemaps are verified, speed latency is ${analysis.seo.siteSpeed || '1.1s'}.`,
      depth: 120
    },
    {
      id: 'seo',
      ...
      metric: `${analysis.seo.coreKeywords.length} Seed Keywords`,
    ...
    },
    {
      ...
      metric: `Cluster: ${analysis.content.corePillar.slice(0, 20)}...`,
    ...
    },
    {
      ...
      metric: `Budget: ${analysis.ads.monthlyBudgetRecommendation}`,
